...
class PostCommentView: UIView, NibLoadable {
    ...
    override func awakeFromNib() {
        ...
        collectionView.register(cellType: EmojiCollectionCell.self)
    }
...
extension PostCommentView: UITextViewDelegate {
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        postButton.setTitleColor((textView.text.count != 0) ? kBaseColor : kAssistTextColor, for: .normal)
...
extension PostCommentView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: EmojiCollectionCell.self)
