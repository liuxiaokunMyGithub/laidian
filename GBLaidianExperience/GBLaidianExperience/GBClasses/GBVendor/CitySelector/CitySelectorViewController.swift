...
typealias SelectCityBlock = (_ str:String)->Void
...
class CitySelectorViewController: UIViewController {
    //更新位置闭包
    var updateCityName:SelectCityBlock?
...
//        searchVc.dimsBackgroundDuringPresentation = false
    ...
    private func setupUI() {
        ...
        // 设置导航条
        self.title = "选择城市"
        self.navigationController?.navigationBar.barTintColor = kImportantTextColor
        self.navigationController?.navigationBar.tintColor = kImportantTextColor
        ...
        // 右边索引
        tableView.sectionIndexColor = kBaseColor
        tableView.sectionIndexTrackingBackgroundColor = UIColor.white
        tableView.sectionIndexBackgroundColor = UIColor.ColorFromHexStr(hexString: "#FBFBFB")
...
//            }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.updateCityName!((cell?.textLabel?.text)!)
        self.backToHomeView()
    }
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let view = UIView(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: section == 0 ? 50 : sectionMargin))
        
        let titleLabel = UILabel(frame: CGRect(x: 15, y: section == 0 ? 10 :0, width: ScreenWidth - 15, height: 30))
        var titleArr = titleArray
        titleArr[0] = "当前城市：大连"
        titleArr[1] = "最近选择城市"
        titleArr[2] = "热门城市"
        titleLabel.text = titleArr[section]
        titleLabel.textColor = kImportantTextColor
        titleLabel.font = XKFont.pingFangSCRegular.size(14)
        view.addSubview(titleLabel)
        
        view.backgroundColor = UIColor.white
        
        if section > 0 {
            titleLabel.textColor = kAssistTextColor
    ...
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        return section == 0 ? 50 : sectionMargin
    }
