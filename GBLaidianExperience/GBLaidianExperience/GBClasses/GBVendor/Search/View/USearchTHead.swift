...
class USearchTHead: GBBaseTableViewHeaderFooterView {
...
//    }()
    ...
    override func configUI() {
        ...
        self.headerFooterStyle = .BaseHeaderFooterStyleImageDefault
//        baseIndicateButton.addTarget(self, action: #selector(moreAction), for: .touchUpInside)

//        contentView.addSubview(baseTitleLabel)
...
//        contentView.addSubview(baseIndicateButton)
